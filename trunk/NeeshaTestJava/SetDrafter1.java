 ...
 */
public class SetDrafter1 extends SmartAgentBase
{
//	Logger logger;
    /**
...
//        logger = new Logger(board);
        if (Logger.UseSelf()) {
        	ourNumber = 1;
        } else if (board.getAgentName(0).equalsIgnoreCase("SetDrafter1")) {
        	ourNumber = 0;
        } else if (board.getAgentName(1).equalsIgnoreCase("SetDrafter1")) {
        	ourNumber = 1;
        } else if (board.getAgentName(2).equalsIgnoreCase("SetDrafter1")) {
        	ourNumber = 2;
        }

        System.out.println("SD2 is " + ourNumber);
    ...
    {
//    	int[] picks = {39,5,37,10,38,28,24,20,8,36,26,1,6,0};
//    	int[] picks = {0, 12, 14, 15, 21, 22, 29, 30, 31, 32, 33, 34, 38, 7};
//    	int[] picks = {1, 12, 13, 21, 22, 23, 27, 3, 30, 32, 34, 35, 37, 38};
//    	int[] picks = {1, 15, 16, 17, 2, 20, 22, 24, 25, 26, 34, 35, 4, 6};
//    	int[] picks = {0, 12, 14, 17, 2, 23, 25, 27, 30, 33, 38, 39, 40, 41};
//    	System.out.println("SD2 picks " + picks[pick]);
