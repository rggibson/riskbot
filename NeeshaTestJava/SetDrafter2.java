 ...
 */
public class SetDrafter2 extends SmartAgentBase
{
    /**
...
//    Logger logger;
    ...
    public void setPrefs(int ID, Board board )
    {
        ...
        if (Logger.UseSelf()) {
        	ourNumber = 2;
        } else if (board.getAgentName(0).equalsIgnoreCase("SetDrafter2")) {
        	ourNumber = 0;
        } else if (board.getAgentName(1).equalsIgnoreCase("SetDrafter2")) {
        	ourNumber = 1;
        } else if (board.getAgentName(2).equalsIgnoreCase("SetDrafter2")) {
        	ourNumber = 2;
        }
        System.out.println("SD3 is " + ourNumber);
...
//        logger = new Logger(board);
    ...
    {
//    	int[] picks = {32,12,13,33,21,27,18,16,3,23,2,40,22,19};
//    	int[] picks = {1, 10, 11, 18, 19, 24, 25, 3, 35, 36, 39, 4, 40, 41};
//    	int[] picks = {16, 17, 18, 2, 20, 25, 26, 31, 33, 39, 4, 40, 8, 9};
//    	int[] picks = {18, 19, 23, 3, 30, 31, 32, 33, 36, 38, 39, 40, 41, 9};
//    	int[] picks = {1, 11, 15, 16, 18, 20, 24, 28, 29, 3, 37, 4, 7, 8};
