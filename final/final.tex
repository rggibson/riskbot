...
\label{fig:subfigkth1}
}\hspace{5pt}
\subfigure[bla2.]{
\includegraphics[scale=.55]{figs/kthno.png}
\label{fig:subfigkth2}
}
\label{fig:subfigureExample}
\caption[]{Assigning p-orientation edges to a cycle in a non-chordal graph forces a chord: \subref{fig:subfigkth1}, \subref{fig:subfigkth2}}
\end{figure}
...
\label{fig:subfigureExample}
\caption[]{Assigning p-orientation edges to a cycle in a non-chordal graph forces a chord: \subref{fig:subfig1}, \subref{fig:subfig2}}
\end{figure}
...
\label{fig:subfigAct1}
}\hspace{5pt}
\subfigure[bla2.]{
\includegraphics[scale=.55]{figs/2quo.png}
\label{fig:subfigAct2}
}\hspace{5pt}
\subfigure[bla2.]{
...
\label{fig:subfigAct4}
}
\label{fig:subfigureExample}
\caption[]{Assigning p-orientation edges to a cycle in a non-chordal graph forces a chord: \subref{fig:subfigAct1}, \subref{fig:subfigAct2}, \subref{fig:subfigAct3}, \subref{fig:subfigAct4}}
\end{figure}
...
% It would be interesting to see how often KthBestPick is deviating from the top ranked pick provided by 3000 simulations of UCT; unfortunately, we did not have time to reproduce our experiments to gather this and related statistics.

% Mention  why UCT vs UCT vs Quo didn't pan out so well:  Two players following our machine learned reward signal tend to get in each other's way.  For instance, they will not let each other claim all of North America since they both believe it to be too valuable.  All the while Quo gathers an entire continent or two which may not appear too strong in the eyes of our imperfect reward signal, but end up proving to be strong picks nonetheless.
